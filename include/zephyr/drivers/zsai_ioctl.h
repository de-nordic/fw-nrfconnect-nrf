...
#define ZSAI_IOCTL_SYSCALL_BIT(ioctl_id) (1 << ioctl_id)
#define ZSAI_IOCTL_SYSCALL_BIT_SET(bitmap, ioctl_id)			\
	((bitmap) = ((bitmap) | (ZSAI_IOCTL_SYSCALL_BIT(ioctl_id))))

#define ZSAI_IOCTL_SYSCALL_BIT_UNSET(bitmap, ioctl_id)			\
	((bitmap) = ((bitmap) & (~ZSAI_IOCTL_SYSCALL_BIT(ioctl_id))))

#define ZSAI_IOCTL_SYSCALL_BIT_IS_SET(bitmap, ioctl_id)		\
	((bitmap) & (ZSAI_IOCTL_SYSCALL_BIT(ioctl_id)))
